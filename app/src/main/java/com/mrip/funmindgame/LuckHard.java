...
public class LuckHard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_luck_hard);
        ...
        matchLuckyNum.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(getLuckyNum.getText())){
                    Toast.makeText(getApplicationContext(),"Please provide a number (1-50) above to check your luck today!!",Toast.LENGTH_SHORT).show();
                }else {
    ...
    public final double displayRanNumber(){
        ...
        double randomNumber= ran.nextInt(51);
