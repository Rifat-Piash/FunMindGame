...
public class LuckMedium extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_luck_medium);
        ...
        matchLuckyNum.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(getLuckyNum.getText())){
                    Toast.makeText(getApplicationContext(),"Please provide a number (1-20) above to check your luck today!!",Toast.LENGTH_SHORT).show();
                }else {
    ...
    public final double displayRanNumber(){
        ...
        double randomNumber= ran.nextInt(21);
